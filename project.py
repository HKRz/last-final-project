...
FacultyName = ['School of Liberal Arts', 'School of Science', 'School of Management',
               'School of Information Technology', 'School of Agro-industry', 'School of Law',
               'School of Cosmetic Science', 'School of Health Science', 'School of Nursing',
               'School of Social Innovation', 'School of Sinology', 'School of Integrative Medicine', ]

HomeRegion = ['North', 'North East', 'South',
              'Central', 'East', 'Bankok', 'West']
...
def get_input():
    ...
    v_HRegion = st.sidebar.selectbox('Home Region', HomeRegion)
...
.sidebar .sidebar-content{
    background-image: linear-gradient(#f63366,#fffd80);
    color: black;
...
data_sample = pd.read_csv('test_sample.csv')
...
load_mms = pickle.load(open('normalization_v6.pkl', 'rb'))
...
load_knn = pickle.load(open('best_knn_v6.pkl', 'rb'))
